...
export interface ArtifactReadEffect {
  req: RequestId,
...
export interface ArtifactWriteEffect {
  req: RequestId,
...
export interface EffectArtifactRead {
  tag: 'artifact-read',
  val: ArtifactReadEffect,
}
export interface EffectArtifactWrite {
  tag: 'artifact-write',
  val: ArtifactWriteEffect,
}
...
export interface EffectRequestInferenceProposal {
  tag: 'request-inference-proposal',
  val: RequestInferenceProposalEffect,
}
