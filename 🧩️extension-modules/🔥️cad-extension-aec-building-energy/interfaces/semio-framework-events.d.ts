...
export type CloseRequest = import('./semio-framework-instance-lifetime.js').CloseRequest;
...
export type Event = EventInstanceOpen | EventInstanceClose | EventInstanceLifecycleAck | EventActivate | EventSuspendRequest | EventCapabilityChanged | EventQuotaChanged | EventUiIntent | EventSurfaceVisible | EventSurfaceHidden | EventSurfaceResized | EventPatchAck | EventPatchRejected | EventCompleted | EventHttpChunk | EventJobProgress | EventJobCompleted | EventMessage | EventTimer | EventWake | EventRequest;
...
export interface EventInstanceLifecycleAck {
  tag: 'instance-lifecycle-ack',
  val: Receipt,
}
...
export interface EventUiIntent {
  tag: 'ui-intent',
  val: UiIntentEvent,
}
