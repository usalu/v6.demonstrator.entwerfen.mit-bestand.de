...
import { environment, exit as exit$1, stderr, stdin, stdout, terminalInput, terminalOutput, terminalStderr, terminalStdin, terminalStdout } from '../../🔌️plugin-modules/🪞️vendor/🤝️bytecode-alliance/🪟️preview2-shim/cli.js';
import { monotonicClock, wallClock } from '../../🔌️plugin-modules/🪞️vendor/🤝️bytecode-alliance/🪟️preview2-shim/clocks.js';
import { error, poll as poll$2, streams } from '../../🔌️plugin-modules/🪞️vendor/🤝️bytecode-alliance/🪟️preview2-shim/io.js';
import { insecureSeed as insecureSeed$1 } from '../../🔌️plugin-modules/🪞️vendor/🤝️bytecode-alliance/🪟️preview2-shim/random.js';
...
const $init = (() => {
  let gen = (function* _initGenerator () {
    const module0 = fetchCompile(__semioVersionedComponentAssetUrl('./semio_s_plugin_cad_aec_building_structure_component.core.wasm'));
